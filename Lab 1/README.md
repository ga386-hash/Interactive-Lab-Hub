...
**The main input of the light-up sneakers is the pressure of your foot when you step down. Since there are various iterations of the light-up shoe design, we focused on the shoes developed in the 1990s by L.A. Lights, which simply light up red when the shoe hits the ground. For the response, there are different results based on how hard and how fast you step. For example, a stomp would produce the brightest reaction while a soft step barely lights it.**
...
**Light-up sneakers are famous as being one of the first pieces of “wearable tech” in the shoe industry. Its primary strength is the simplicity of the design; it doesn’t require any time to learn how to use, nor excessive buttons or other components to control it. On the other hand, the shoes lack sufficient power for extended use, are an experimental look and not formal attire, and can malfunction by getting stuck “on” or displaying incorrect colors.**
...
- **Goals: The user is walking and drawing attention and the viewer is supplying the attention/analyzing the device.**
...
https://github.com/user-attachments/assets/fdc5fc9a-4f2f-411c-823b-2ac94ce1af51
